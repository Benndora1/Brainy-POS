                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Opening Balance <span class="required_star">*</span></label>
                                <input tabindex="1" type="text" name="opening_balance" class="form-control" placeholder="Opening Balance" value="<?php echo set_value('opening_balance'); ?>">
                            </div>
