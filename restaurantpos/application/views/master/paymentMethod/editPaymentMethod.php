                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="name" class="form-control" placeholder="<?php echo lang('payment_method_name'); ?>" value="<?php echo $payment_method_information->name; ?>">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="2" type="text" name="description" class="form-control" placeholder="<?php echo lang('description'); ?>" value="<?php echo $payment_method_information->description; ?>">
                            </div>
