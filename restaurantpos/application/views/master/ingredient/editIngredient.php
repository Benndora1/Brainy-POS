                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="name" class="form-control" placeholder="<?php echo lang('name'); ?>" value="<?php echo $ingredient_information->name; ?>">
                            </div>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table style="width: 100%">
                                            <tr>
                                                <td> <input tabindex="4" type="text" name="purchase_price" class="form-control integerchk" placeholder="<?php echo lang('purchase_price'); ?>" value="<?php echo $ingredient_information->purchase_price; ?>"></td>
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="5" type="text" name="alert_quantity" class="form-control integerchk" placeholder="<?php echo lang('alert_qty'); ?>" value="<?php echo $ingredient_information->alert_quantity; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="6" type="text" name="code" class="form-control" placeholder="<?php echo lang('code'); ?>" value="<?php echo $ingredient_information->code; ?>">
                            </div>
                        </div> 
