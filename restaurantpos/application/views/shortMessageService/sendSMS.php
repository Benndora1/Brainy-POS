                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" name="outlet_name" class="form-control" placeholder="<?php echo lang('outlet_name'); ?>" value="<?php echo $outlet_name; ?>">
                            </div>
                            ...
                            <?php if($type == 'birthday' || $type == 'anniversary'){?>
                                <div class="form-group">
                                    <?php echo lang('there_are'); ?> <b><?php echo count($sms_count); ?></b> <?php echo lang('customer_has'); ?> <?php echo $type; ?> <?php echo lang('today'); ?>.
                                </div> 
                            <?php } ?>
                            ...
                            <div class="form-group">
                                <?php echo lang('your_current_credit'); ?> <label><b><?php echo $balance;?></b></label> 
