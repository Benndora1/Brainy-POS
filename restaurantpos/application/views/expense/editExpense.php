                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" id="date" name="date" readonly class="form-control" placeholder="<?php echo lang('date'); ?>" value="<?php echo date("Y-m-d", strtotime($expense_information->date)); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="2" type="text" name="amount" onfocus="this.select();"  class="form-control integerchk" placeholder="<?php echo lang('amount'); ?>" value="<?php echo $expense_information->amount; ?>">
                            </div>
                        ...
                        <div class="col-md-6"> 
                            ...
                            <div class="form-group">
                                ...
                                <textarea tabindex="5" class="form-control" rows="4" name="note" placeholder="<?php echo lang('enter'); ?> ..."><?php echo $expense_information->note; ?></textarea>
                            </div> 
