...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#stockValue').html('<?php echo lang('stock_value'); ?>: <?php echo $this->session->userdata('currency'); ?> '+$('#grandTotal').val()+'<a class="top" title="" data-placement="top" data-toggle="tooltip" style="cursor:pointer" data-original-title="Calculated based on last purchase price and Ingredient with negative Stock Qty/Amount is not considered"><i data-feather="help-circle"></i></a>');
    });
</script>  
