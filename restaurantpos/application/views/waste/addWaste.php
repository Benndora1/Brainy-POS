                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="text" id="reference_no" readonly name="reference_no" class="form-control" placeholder="<?php echo lang('ref_no'); ?>" value="<?php echo $pur_ref_no; ?>">
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="3" type="text" id="date" name="date" readonly class="form-control" placeholder="<?php echo lang('date'); ?>" value="<?php echo set_value('date'); ?>">
                            </div>
                            ...
                            <div class="form-group"> 
                                ...
                                <select tabindex="4" class="form-control select2 select2-hidden-accessible" name="employee_id" id="employee_id" style="width: 100%;">
                                    ...
                                    <?php foreach ($employees as $empls) { ?>
                                        <option value="<?php echo $empls->id; ?>" <?php echo set_select('unit_id', $empls->id); ?>><?php echo $empls->full_name ?></option>
                                    <?php } ?>
                                </select>
                            </div>  
                    ...
                    <div class="row" id="food_menu_waste_quantity_row" style="display:none;">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input tabindex="1" type="number" id="waste_quantity" name="food_menu_waste_qty" class="form-control" placeholder="<?php echo lang('waste_quantity'); ?>" value="">
                            </div>
...
<?php } ?>
                        ...
                        <div class="col-md-4">
                            <button type="button" style="margin:25px 0px 0px 0px;" class="btn btn-danger" id="delete_all_ingredient_list"><?php echo lang('delete'); ?></button>
                        </div>
...
<?php } ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea tabindex="3" class="form-control" rows="2" id="note" name="note" placeholder="<?php echo lang('enter'); ?> ..."><?php echo $this->input->post('note'); ?></textarea>
                            </div>
...
<?php } ?> 
                        ...
                        <div class="modal-footer">
                            <input id="food_menu_waste_button" type="button"  value="<?php echo lang('submit'); ?>" class="btn btn-primary">
