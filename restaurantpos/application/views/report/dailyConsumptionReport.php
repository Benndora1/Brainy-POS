...
<section class="content-header"> 
    <h3>Daily Consumption Report</h3>
    <hr style="border: 1px solid #3c8dbc;">
    <div class="row">
        <div class="col-md-2">
            <?php echo form_open(base_url() . 'Report/dailyConsumptionReport') ?>
        ...
        <div class="col-md-offset-8 col-md-1">
            <div class="form-group"> 
                <a class="btn btn-block btn-primary pull-left" href="<?php echo base_url(); ?>Report/printDailyConsumptionReport/<?php echo $selectedDate; ?>">Print</a>
            </div>
        </div>
    </div> 
</section> 
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">  
                ...
                <div class="box-body table-responsive"> 
                    ...
                    <hr>
                    <h4 style="font-weight: bold; text-align: center; margin-top: 20px;">Food Menu Consumption</h4>
                    <hr>
                    ...
                    <hr>
                    <h4 style="font-weight: bold; text-align: center; margin-top: 20px;">Modifier Consumption</h4>
                    <hr>
                    <table style="width: 100%" class="tbl">    
                        <tr>
                            <th style="font-weight: bold; text-align: center;">SN</th>
