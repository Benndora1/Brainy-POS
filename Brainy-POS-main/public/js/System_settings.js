...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(["refreshUserPermissions"])), {}, {
    ...
    Update_Settings: function Update_Settings() {
      ...
      self.data.append("till", self.setting.till);
    ...
    Update_Pos_Settings: function Update_Pos_Settings() {
      ...
      axios.put("pos_settings/" + this.pos_settings.id, {
        ...
        show_till: this.pos_settings.show_till
...
var render = function render() {
  ...
  return _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(validationContext) {
        return [_c("b-form-group", {
          ...
          attrs: {
            state: _vm.getValidationState(validationContext),
            "aria-describedby": "till-feedback"
          },
          model: {
            value: _vm.setting.till,
            callback: function callback($$v) {
              _vm.$set(_vm.setting, "till", $$v);
            },
            expression: "setting.till"
          }
        }), _vm._v(" "), _c("b-form-invalid-feedback", {
          attrs: {
            id: "till-feedback"
    ...
    domProps: {
      checked: Array.isArray(_vm.pos_settings.show_till) ? _vm._i(_vm.pos_settings.show_till, null) > -1 : _vm.pos_settings.show_till
    },
    on: {
      change: function change($event) {
        var $$a = _vm.pos_settings.show_till,
          $$el = $event.target,
          $$c = $$el.checked ? true : false;
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.pos_settings, "show_till", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.pos_settings, "show_till", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.$set(_vm.pos_settings, "show_till", $$c);
        }
      }
    }
  }), _vm._v(" "), _c("span", {
